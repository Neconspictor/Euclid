...
IF(ASSIMP_FOUND)
  ...
  set_target_properties(ASSIMP PROPERTIES IMPORTED_LOCATION_RELWITHDEBINFO "${ASSIMP_IMPORTED_LIB_RELEASE}")
  set_target_properties(ASSIMP PROPERTIES IMPORTED_LOCATION_MINSIZEREL "${ASSIMP_IMPORTED_LIB_RELEASE}")
