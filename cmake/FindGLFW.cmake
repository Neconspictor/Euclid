...
IF(GLFW_FOUND)
    ...
    set_target_properties(GLFW PROPERTIES IMPORTED_LOCATION_RELWITHDEBINFO "${GLFW_LIBRARY_RELEASE}")
    set_target_properties(GLFW PROPERTIES IMPORTED_LOCATION_MINSIZEREL "${GLFW_LIBRARY_RELEASE}")
