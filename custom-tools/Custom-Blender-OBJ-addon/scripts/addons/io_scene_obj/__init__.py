...
class ExampleAddonPreferences(AddonPreferences):
    ...
    filepath = StringProperty(
            name="Relative File stripping path",
            subtype='FILE_PATH',
            )
    strip = BoolProperty(
            name="Strip all paths by the specified relative path",
            default=False,
            )
...
class OBJECT_OT_addon_prefs_example(Operator):
    ...
    def execute(self, context):
        ...
        info = ("Path: %s, Boolean %r" %
                (addon_prefs.filepath, addon_prefs.strip))
...
class ExportOBJ(bpy.types.Operator, ExportHelper, IOOBJOrientationHelper):
    ...
    relative_file_directory = StringProperty(
            name="Relative Path directory",
            description="File path will be relative matched to the specified path",
            default="",
            )        
