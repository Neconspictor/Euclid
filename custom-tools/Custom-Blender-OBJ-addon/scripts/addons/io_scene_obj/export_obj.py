...
def write_mtl(scene, filepath, path_mode, copy_set, mtl_dict, EXPORT_RELATIVE_PATH):
...
def write_file(filepath, objects, scene,
    ...
    with ProgressReportSubstep(progress, 2, "OBJ Export path: %r" % filepath, "OBJ Export Finished") as subprogress1:
        ...
        if EXPORT_MTL:
            write_mtl(scene, mtlfilepath, EXPORT_PATH_MODE, copy_set, mtl_dict, EXPORT_RELATIVE_PATH)
...
def save(context,
         ...
         *,
         ...
         use_animation=False,
         global_matrix=None,
         relative_file_directory="",
         path_mode='AUTO'
         ):

         #_write bpy.context.user_preferences.addons[__name__].preferences.filepath
    ...
    _write(context, filepath,
           ...
           EXPORT_RELATIVE_PATH=relative_file_directory,
