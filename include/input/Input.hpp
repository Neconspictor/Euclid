...
public:
	...
	*/
	...
	virtual void addScrollListener(ScrollListener& listener);
	virtual void removeScrollListener(ScrollListener& listener);
...
protected:
	...
	std::list<ScrollListener*> scrollListeners;
};
