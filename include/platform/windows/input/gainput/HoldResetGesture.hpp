...
#ifndef HOLD_RESET_GESTURE_HPP
#define HOLD_RESET_GESTURE_HPP
...
namespace gainput {
	...
	enum HoldResetAction
	{
		HoldResetTriggered		///< The button that triggers after holding for the given time.
	};
	...
	*/
	class HoldResetGesture : public InputGesture
	{
	public:
		/// Initializes the gesture.
		HoldResetGesture(InputManager& manager, DeviceId device, unsigned index, DeviceVariant variant);
