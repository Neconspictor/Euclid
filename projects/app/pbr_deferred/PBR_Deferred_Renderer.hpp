...
namespace nex
{
	...
	private:
		...
		std::unique_ptr<RenderTarget2D> mTempRenderTarget;
		std::unique_ptr<RenderTarget2D> mTempRenderTargetEidth1;
		std::unique_ptr<RenderTarget2D> mTempRenderTargetEidth2;
