...
namespace TestMeshes {
	...
	static const std::string CUBE_POSITION_UV_NAME = "TESTMESHES::CUBE";
	static unsigned int CUBE_POSITION_UV_VERTEX_SLICE = 5;
    static const float cubePositionUVVertices [] = {
	...
	static const std::string CUBE_POSITION_NAME = "TESTMESHES::CUBE_POSITION";
	static unsigned int CUBE_POSITION_VERTEX_SLICE = 3;
	static const float cubePositionVertices[] = {
		-0.5f, -0.5f, -0.5f,
		0.5f, -0.5f, -0.5f,
		0.5f,  0.5f, -0.5f,
		0.5f,  0.5f, -0.5f,
	...
	static const std::string CUBE_POSITION_NORMAL_NAME = "TESTMESHES::CUBE_POSITION_NORMAL";
	static unsigned int CUBE_POSITION_NORMAL_VERTEX_SLICE = 6;
	static const float cubePositionNormalVertices[] = {
