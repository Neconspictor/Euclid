#include <nex/memory/FreeListAllocator.hpp>
	...
	void* FreeListAllocator::alloc(size_t size, uint64_t alignment)
	{
		...
		while (free_block != nullptr)
		{
			...
			else
			{
				...
				FreeBlock* next_block = (FreeBlock*)(nex::util::add(free_block, (int)total_size));
			...
			AllocationHeader* header = (AllocationHeader*)nex::util::subtract(alignedAddress, sizeof(AllocationHeader));
