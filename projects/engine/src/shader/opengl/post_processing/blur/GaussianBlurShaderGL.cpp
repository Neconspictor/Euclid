...
GaussianBlurHorizontalShaderGL::GaussianBlurHorizontalShaderGL() : GaussianBlurHorizontalShader(), ShaderConfigGL(), image(nullptr), width(800)
{
...
GaussianBlurVerticalShaderGL::GaussianBlurVerticalShaderGL() : GaussianBlurVerticalShader(), ShaderConfigGL(), image(nullptr), height(800)
{
	imageAttribute = attributes.create(ShaderAttributeType::TEXTURE2D, nullptr, "image");
