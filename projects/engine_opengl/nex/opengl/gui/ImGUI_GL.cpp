...
bool ImGUI_GL::createDeviceObjects()
{
	...
	RendererOpenGL::checkGLErrors("ImGUI_GL.cpp<createDeviceObjects>001");
	glLinkProgram(g_ShaderHandle);
	RendererOpenGL::checkGLErrors("ImGUI_GL.cpp<createDeviceObjects>002");

	RendererOpenGL::checkGLErrors("ImGUI_GL.cpp");

	g_AttribLocationTex = glGetUniformLocation(g_ShaderHandle, "Texture");

	RendererOpenGL::checkGLErrors("ImGUI_GL.cpp<createDeviceObjects>XXX");
...
{
	RendererOpenGL::checkGLErrors("ShaderGL.cpp<createFontsTexture>000");
	// Build texture atlas
	ImGuiIO& io = ImGui::GetIO();
	...
	RendererOpenGL::checkGLErrors("ShaderGL.cpp<createFontsTexture>001");

	// Restore state
	glBindTexture(GL_TEXTURE_2D, last_texture);

	RendererOpenGL::checkGLErrors("ShaderGL.cpp<createFontsTexture>XXX");
}
