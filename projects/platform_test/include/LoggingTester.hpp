...
public:
	...
	{
		logDetailed(logger, level) << "Hello World! " << test << std::endl;
		++test;
	}
...
public:
	...
	{
		logDetailed(logger, platform::Warning) << "MyMessageHandler: msg="
...
public:
	...
	{
		logDetailed(logger, platform::Warning) << "IntHandler: value= " << event.value << std::endl;
	}
};
